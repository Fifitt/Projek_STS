...
<html lang="en">
    ...
    <div class="about">
        ...
        <div class="servise">
            ...
            <div class="box">
                ...
                <i class="fa-solid fa-bars"></i>
                    ...
                    <div class="pra">
                        <p>mengerjakan jasa web termasuk dari keahlian kami</p>
                    ...
                    <div class="card">
                        ...
                        <h5>Desain Grafis</h5>
                        <div class="pra">
                            <p>Selainsebagai Web Development saya juga mahir dalan desain grafis</p>
                            <p style="text-align: center;"></p>
                            <a href="#" class="button">Read More</a>
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div class="pra">
                            <p>saya juga ahli dalam bidang android Development</p>
                            <p style="text-align: center;"></p>
                            <a href="#" class="button">Read More</a>
                        </div>
                    </div>
        ...
        <div class="kontak-saya">
            ...
            <a href="#" class="button-dua">Hubungi Kami</a>
        </div>
        <footer>
            <p>Fifit sholikhatul mufalah</p>
            <p>Untuk lebih mengenaltentang saya hubungi</p>
            <div class="sosial">
                <a href="#"><i class="fa-brands fa-facebook"></i></a>
                <a href="#"><i class="fa-brands fa-whatsapp"></i></a>
                <a href="#"><i class="fa-brands fa-instagram"></i></a>
            </div>
            <p class="end">CopyRight@fifitsholikhatulmufalah.com</p>
        </footer>
